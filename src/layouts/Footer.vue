    ...
    <div class="container">
		<div class="row">
			<div class="col-lg-4">
				...
				<p>Niagara Falls, St. Catharines, <g-link to="/welland-web-design">Welland</g-link>, Thorold, Port Colborne, Fort Erie, <g-link to="/grimsby-web-design">Grimsby</g-link>, Lincoln, Niagara-on-the-Lake, Pelham, Wainfleet, Vineland, Beamsville, West Lincoln.</p>
			</div>
			<div class="col-lg-4">
