...
const Burlington = () => {
  return (
    <>
      <Helmet>
        <title>Burlington Web Design & SEO Company - Infused</title>
        <meta
          name="description"
          content="Burlington's best web design and SEO company around. 10+ years in business helping hundreds of clients. Click here to view portfolio."
        />
      </Helmet>
      <Nav />
      <InnerHero
        title="Burlington Web Design & SEO Company"
        description="We help local Burlington businesses drive traffic & increase revenue online."
      />
      <InnerContent>
        <section className="grimsby">
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-lg-6">
                <img
                  src={kdImg}
                  className="img-fluid"
                  alt="Burlington web design & seo company"
                />
              </div>
            </div>
          </div>
          ...
          <section className="niche-intro">
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-md-12">
                  <h2>Why Your Burlington Business Needs A Successful Website</h2>
                  <p>
                    ...
                    Googles what they need, it's imperative to hire a Burlington
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2>How can Search Engine Optimization (SEO) help your Burlington business?</h2>
                  <p>
                  ...
                  <p>
                  This is why it is super important that you have a website that has it's <a href="/port-colborne-web-design">search engine optimization</a> up to snuff and performing well. Because if your website is not search engine optimized at all, you can count on getting exactly zero business from it!
                  </p>
                  <p>
