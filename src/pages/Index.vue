        ...
        <div class="row">
          <div class="col-lg-8" data-aos="fade-up" data-aos-duration="1000">
            <g-image
              ...
              src="~/img/niagara-web-design-st-catharines-development.jpg"
              class="img-fluid"
            />
          </div>
    ...
    <section class="process" data-aos="fade-in" data-aos-duration="1000">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h2>Our Process</h2>
            <p>A simple process that gets your business sales:</p>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4">
...
export default {
  metaInfo: {
    title: "Niagara Web Design & Development, St. Catharines",
    meta: [
      {
        key: "description",
        name: "description",
