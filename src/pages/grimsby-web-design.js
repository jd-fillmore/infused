...
const City = () => {
  return (
    <>
      <Helmet>
        <title>Grimsby Web Design &amp; SEO | Infused</title>
        <meta
          name="description"
          content="Grimsby's leading web design &amp; SEO marketing agency. We're a website design agency thats brings more sales to your Grimsby company."
        />
      </Helmet>
      <Nav />
      <Hero
        titleTwo="Web Design Grimsby, SEO"
        subTitle="We do modern web design &amp; build modern websites to help you grow your Grimsby company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        img={featuredImg}
        imgAlt="Grimsby web design"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Grimsby and I was very happy with their ",
      ...
      />
      <Process
        title="How Our Grimsby Web Design Process Works"
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Grimsby website design</h2>
              <p>
              ...
              <h3>
                Your Grimsby web design will build trust and credibility for
                your company
              </h3>
              <p>
                With so many Grimsby businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d46546.25028176611!2d-79.61592802281622!3d43.18555971682981!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882caf79ccfea3dd%3A0x9566109eba2a4656!2sGrimsby%2C%20ON!5e0!3m2!1sen!2sca!4v1633405288972!5m2!1sen!2sca"
                width="100%"
                height="450"
      ...
      <section className="clients text-center">
        ...
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Grimsby</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Grimsby business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Grimsby web design and SEO needs!!"
                  </p>
