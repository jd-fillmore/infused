            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  ...
                  <p>
                    <a
                      href="https://en.wikipedia.org/wiki/Hamilton,_Ontario"
                      target="_blank"
                      rel="noreferrer"
                    >
                      This town
                    </a>{" "}
                    is very well known for its surrounding wineries, orchards
                    and vineyards. The town also has a great variety of
                    restaurants, as well as local produce. There are a very
                    large number of farms, as well as greenhouses in the area as
                    those features are a major economic driver. The crops
                    produced in the area include peaches, pears, apples and
                    cherries. This small town is recognized on a national scale
                    as Canada's premier tender fruit region.
                  </p>
                </div>
              </div>
            </div>
