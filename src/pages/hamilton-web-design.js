...
const Hamilton = () => {
  return (
    <>
      <Helmet>
        <title>Hamilton Web Design & SEO Company - Infused</title>
        <meta
          name="description"
          content="Hamilton's best web design and SEO company around. 10+ years in business helping hundreds of clients. Click here to view portfolio."
        />
      </Helmet>
      <Nav />
      <InnerHero
        title="Hamilton Web Design & SEO Company"
        description="We help local Hamilton businesses drive traffic & increase revenue online."
      />
      <InnerContent>
        <section className="grimsby">
          ...
          <section className="niche-intro">
              ...
              <div className="row">
                <div className="col-md-12">
                  <p>
                    ...
                    <Link to="/burlington-web-design"> website design.</Link>
                    <br />
                    <br />
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2>How can Search Engine Optimization (SEO) help your Hamilton business?</h2>
                  <p>
