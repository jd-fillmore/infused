...
import kdImg from "../img/pelham-web-design-seo.png"
...
const Pelham = () => {
  return (
    <>
      <Helmet>
        <title>Pelham Web Design & SEO Company - Infused</title>
        <meta
          name="description"
          content="Pelham's best web design and SEO company around. 10+ years in business helping hundreds of clients. Click here to view portfolio."
        />
      </Helmet>
      <Nav />
      <InnerHero
        title="Pelham Web Design & SEO Company"
        description="We help local Pelham businesses drive traffic & increase revenue online."
      />
      <InnerContent>
        <section className="grimsby">
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-lg-6">
                <img
                  src={kdImg}
                  className="img-fluid"
                  alt="Pelham web design & seo company"
                />
              </div>
            </div>
          </div>
          ...
          <section className="niche-intro">
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-md-12">
                  <h2>Why Your Pelham Business Needs A Successful Website</h2>
                  <p>
                    ...
                    Googles what they need, it's imperative to hire a Pelham
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2>
                    How can Search Engine Optimization (SEO) help your Pelham
                    business?
                  </h2>
                  <p>
