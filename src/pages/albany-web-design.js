...
import featuredImg from "../img/albany-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Albany NY Web Design & SEO Marketing Company - Infused Agency
        </title>
        <meta
          name="description"
          content="Albany NY's leading web design &amp; SEO marketing agency. We're a website design agency thats brings more sales to your Albany NY company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Albany NY Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Albany NY Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Albany NY company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Albany NY area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Albany NY web design"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Albany NY and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Albany NY Web Designers Can Do For You"
        subTitle="Whether you need an professional Albany NY web design to showcase your services in Albany NY or want more local Albany NY customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Albany NY visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Albany NY companies that help convert Albany NY users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Albany NY website.",
        ]}
        boxTwoDesc="Getting local Albany NY traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Albany NY</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Albany NY business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Albany NY, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Albany NY business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Albany NY area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Albany NY web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Albany NY website design</h2>
              <p>
              ...
              <p>
                With so many Albany NY businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d46938.923115910235!2d-73.84578606281771!3d42.6680790405955!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89de0a34cc4ffb4b%3A0xe1a16312a0e728c4!2sAlbany%2C%20NY%2C%20USA!5e0!3m2!1sen!2sca!4v1609178088466!5m2!1sen!2sca"
                width="100%"
                title="Albany NY map"
                height="450"
                frameborder="0"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Albany NY</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Albany NY business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Albany NY web design and SEO needs!!"
                  </p>
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Albany NY area. We help local and non-local
