...
import featuredImg from "../img/gravenhurst-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Gravenhurst Web Design & SEO Marketing Company - Infused Agency
        </title>
        <meta
          name="description"
          content="Gravenhurst's leading web design &amp; SEO marketing agency. We're a website design agency thats brings more sales to your Gravenhurst company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Gravenhurst Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Gravenhurst Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Gravenhurst company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Gravenhurst area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Gravenhurst web design"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Gravenhurst and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Gravenhurst Web Designers Can Do For You"
        subTitle="Whether you need an professional Gravenhurst web design to showcase your services in Gravenhurst or want more local Gravenhurst customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Gravenhurst visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Gravenhurst companies that help convert Gravenhurst users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Gravenhurst website.",
        ]}
        boxTwoDesc="Getting local Gravenhurst traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Gravenhurst</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Gravenhurst business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Gravenhurst, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Gravenhurst business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Gravenhurst area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Gravenhurst web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Gravenhurst website design</h2>
              <p>
              ...
              <p>
                With so many Gravenhurst businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d180909.73672963973!2d-79.4392247480421!3d44.88845596094283!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4d2a9afaa848a8b9%3A0x25c89fc10a8cc64b!2sGravenhurst%2C%20ON!5e0!3m2!1sen!2sca!4v1609178605002!5m2!1sen!2sca"
                width="100%"
                title="Gravenhurst map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Gravenhurst</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Gravenhurst business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Gravenhurst web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Gravenhurst
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Gravenhurst area. We help local and non-local
