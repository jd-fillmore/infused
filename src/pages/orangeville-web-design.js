...
import featuredImg from "../img/orangeville-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Orangeville Web Design Company | Best Website Designers - Infused
          Agency
        </title>
        <meta
          name="description"
          content="Orangeville's best web design company. We're a website design agency thats brings more sales to your Orangeville company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Orangeville Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Orangeville Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Orangeville company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to Cass-A-Bella Construction's online existence by bringing them leads from the Orangeville area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Orangeville web design company"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Orangeville and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Orangeville Web Designers Can Do For You"
        subTitle="Whether you need an professional Orangeville web design to showcase your services in Orangeville or want more local Orangeville customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Orangeville visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Orangeville companies that help convert Orangeville users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Orangeville website.",
        ]}
        boxTwoDesc="Getting local Orangeville traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Orangeville</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Orangeville business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Orangeville, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Orangeville business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Orangeville area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Orangeville web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Orangeville website design</h2>
              <p>
              ...
              <p>
                With so many Orangeville businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d22994.257268380326!2d-80.12118130210676!3d43.91213210667909!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882baa7290bd23f9%3A0x8230f603f1c45e1c!2sOrangeville%2C%20ON!5e0!3m2!1sen!2sca!4v1608678727313!5m2!1sen!2sca"
                width="100%"
                title="Orangeville map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Orangeville</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Orangeville business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Orangeville web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Orangeville
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Orangeville area. We help local and non-local
