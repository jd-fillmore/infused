...
const StoneyCreek = () => {
  return (
    <>
      <Helmet>
        <title>Stoney Creek Web Design & SEO Company - Infused</title>
        <meta
          name="description"
          content="Stoney Creek's best web design and SEO company around. 10+ years in business helping hundreds of clients. Click here to view portfolio."
        />
      </Helmet>
      <Nav />
      <InnerHero
        title="Stoney Creek Web Design & SEO Company"
        description="We help local Stoney Creek businesses drive traffic & increase revenue online."
      />
      <InnerContent>
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-lg-6">
                <img
                  src={kdImg}
                  className="img-fluid"
                  alt="Stoney Creek web design & seo company"
                />
              </div>
            </div>
          </div>
          ...
          <section className="niche-intro">
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-md-12">
                  <h2>
                    Why Your Stoney Creek Business Needs A Successful Website
                  </h2>
                  <p>
                    ...
                    Googles what they need, it's imperative to hire a Stoney
                    Creek website development company that knows what they're
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2>
                    How can Search Engine Optimization (SEO) help your Stoney
                    Creek business?
                  </h2>
                  <p>
