...
import featuredImg from "../img/stoney-creek-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Stoney Creek Web Design & SEO Marketing Company - Infused Agency
        </title>
        <meta
          name="description"
          content="Stoney Creek's leading web design &amp; SEO marketing agency. We're a website design agency thats brings more sales to your Stoney Creek company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Stoney Creek Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Stoney Creek Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Stoney Creek company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Stoney Creek area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Stoney Creek web design"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Stoney Creek and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Stoney Creek Web Designers Can Do For You"
        subTitle="Whether you need an professional Stoney Creek web design to showcase your services in Stoney Creek or want more local Stoney Creek customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Stoney Creek visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Stoney Creek companies that help convert Stoney Creek users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Stoney Creek website.",
        ]}
        boxTwoDesc="Getting local Stoney Creek traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Stoney Creek</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Stoney Creek business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Stoney Creek, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Stoney Creek business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Stoney Creek area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Stoney Creek web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Stoney Creek website design</h2>
              <p>
              ...
              <p>
                With so many Stoney Creek businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d93034.31554338924!2d-79.7827280420456!3d43.223700536498335!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882c9887eb98cea3%3A0x2665b08690bb3d44!2sStoney%20Creek%2C%20Hamilton%2C%20ON!5e0!3m2!1sen!2sca!4v1609177486734!5m2!1sen!2sca"
                width="100%"
                title="Stoney Creek map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Stoney Creek</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Stoney Creek business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Stoney Creek web design and SEO needs!!"
                  </p>
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Stoney Creek area. We help local and
