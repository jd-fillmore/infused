...
import featuredImg from "../img/richmond-hill-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Richmond Hill Web Design Company | Best Website Designers - Infused
          Agency
        </title>
        <meta
          name="description"
          content="Richmond Hill's best web design agency. We're a website design agency thats brings more sales to your Richmond Hill company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Richmond Hill Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Richmond Hill Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Richmond Hill company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Richmond Hill area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Richmond Hill web design company"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Richmond Hill and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Richmond Hill Web Designers Can Do For You"
        subTitle="Whether you need an professional Richmond Hill web design to showcase your services in Richmond Hill or want more local Richmond Hill customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Richmond Hill visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Richmond Hill companies that help convert Richmond Hill users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Richmond Hill website.",
        ]}
        boxTwoDesc="Getting local Richmond Hill traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Richmond Hill</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Richmond Hill business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Richmond Hill, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Richmond Hill business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Richmond Hill area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Richmond Hill web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Richmond Hill website design</h2>
              <p>
              ...
              <p>
                With so many Richmond Hill businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d91990.1040878547!2d-79.49834058831345!3d43.903671246943254!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b2a4936291733%3A0x5201760ad6b142ed!2sRichmond%20Hill%2C%20ON!5e0!3m2!1sen!2sca!4v1609213661509!5m2!1sen!2sca"
                width="100%"
                title="Richmond Hill map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>
                Our Happy Web Design Clients In Or Outside Of Richmond Hill
              </h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Richmond Hill business I do
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Richmond Hill web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Richmond
                Hill web design or SEO project today.
              </p>
              <Link to="/get-started">
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Richmond Hill area. We help local and
