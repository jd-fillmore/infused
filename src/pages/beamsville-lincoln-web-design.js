...
import kdImg from "../img/beamsville-web-design-seo.png"
...
const BeamsvilleLincoln = () => {
  return (
    <>
      <Helmet>
        <title>Beamsville-Lincoln Web Design & SEO Company - Infused</title>
        <meta
          name="description"
          content="Beamsville-Lincoln's best web design and SEO company around. 10+ years in business helping hundreds of clients. Click here to view portfolio."
        />
      </Helmet>
      <Nav />
      <InnerHero
        title="Beamsville-Lincoln Web Design & SEO Company"
        description="We help local Beamsville-Lincoln businesses drive traffic & increase revenue online."
      />
      <InnerContent>
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-lg-6">
                <img
                  src={kdImg}
                  className="img-fluid"
                  alt="Beamsville-Lincoln web design & seo company"
                />
              </div>
            </div>
          </div>
          ...
          <section className="niche-intro">
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-md-12">
                  <h2>
                    Why Your Beamsville-Lincoln Business Needs A Successful
                    Website
                  </h2>
                  <p>
                    ...
                    Googles what they need, it's imperative to hire a
                    Beamsville-Lincoln website development company that knows
                    what they're doing. You have to make sure that your company
                    is professional represented in a mordern way - so that when
                    people go to your website, they're amazed. They're
                    impressed. And ultimately, your web design converts them
...
export default BeamsvilleLincoln
