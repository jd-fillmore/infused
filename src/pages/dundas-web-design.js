...
const Dundas = () => {
  return (
    <>
      <Helmet>
        <title>Dundas Web Design & SEO Company - Infused</title>
        <meta
          name="description"
          content="Dundas's best web design and SEO company around. 10+ years in business helping hundreds of clients. Click here to view portfolio."
        />
      </Helmet>
      <Nav />
      <InnerHero
        title="Dundas Web Design & SEO Company"
        description="We help local Dundas businesses drive traffic & increase revenue online."
      />
      <InnerContent>
        <section className="grimsby">
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-lg-6">
                <img
                  src={kdImg}
                  className="img-fluid"
                  alt="Dundas web design & seo company"
                />
              </div>
            </div>
          </div>
          ...
          <section className="niche-intro">
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-md-12">
                  <h2>Why Your Dundas Business Needs A Successful Website</h2>
                  <p>
                    ...
                    Googles what they need, it's imperative to hire a Dundas
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2>
                    How can Search Engine Optimization (SEO) help your Dundas
                    business?
                  </h2>
                  <p>
