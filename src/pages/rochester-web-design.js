...
import featuredImg from "../img/rochester-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Rochester NY Web Design & SEO Marketing Company - Infused Agency
        </title>
        <meta
          name="description"
          content="Rochester NY's leading web design &amp; SEO marketing agency. We're a website design agency thats brings more sales to your Rochester NY company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Rochester NY Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Rochester NY Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Rochester NY company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Rochester NY area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Rochester NY web design"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Rochester NY and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Rochester NY Web Designers Can Do For You"
        subTitle="Whether you need an professional Rochester NY web design to showcase your services in Rochester NY or want more local Rochester NY customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Rochester NY visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Rochester NY companies that help convert Rochester NY users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Rochester NY website.",
        ]}
        boxTwoDesc="Getting local Rochester NY traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Rochester NY</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Rochester NY business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Rochester NY, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Rochester NY business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Rochester NY area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Rochester NY web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Rochester NY website design</h2>
              <p>
              ...
              <p>
                With so many Rochester NY businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d93091.39420080782!2d-77.68660982125606!3d43.18628520007755!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d6b3059614b353%3A0x5a001ffc4125e61e!2sRochester%2C%20NY%2C%20USA!5e0!3m2!1sen!2sca!4v1609177946142!5m2!1sen!2sca"
                width="100%"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Rochester NY</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Rochester NY business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Rochester NY web design and SEO needs!!"
                  </p>
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Rochester NY area. We help local and
