...
const PortColborne = () => {
  return (
    <>
      <Helmet>
        <title>Port Colborne Web Design & SEO Company - Infused</title>
        <meta
          name="description"
          content="Port Colborne's best web design and SEO company around. 10+ years in business helping hundreds of clients. Click here to view portfolio."
        />
      </Helmet>
      <Nav />
      <InnerHero
        title="Port Colborne Web Design & SEO Company"
        description="We help local Port Colborne businesses drive traffic & increase revenue online."
      />
      <InnerContent>
        <section className="grimsby">
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-lg-6">
                <img
                  src={kdImg}
                  className="img-fluid"
                  alt="Port Colborne web design & seo company"
                />
              </div>
            </div>
          </div>
          ...
          <section className="niche-intro">
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-md-12">
                  <h2>Why Your Port Colborne Business Needs A Successful Website</h2>
                  <p>
                    ...
                    Googles what they need, it's imperative to hire a Port Colborne
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2>How can Search Engine Optimization (SEO) help your Port Colborne business?</h2>
                  <p>
                  ...
                  <p>
                  This is why it is super important that you have a website that has it's <a href="/burlington-web-design">search engine optimization</a> up to snuff and performing well. Because if your website is not search engine optimized at all, you can count on getting exactly zero business from it!
                  </p>
                  <p>
                  ...
                  <p><a href="https://www.lyfemarketing.com/blog/local-seo/" target="_blank" rel="noopener noreferrer">95% of people search on Google for a local business</a> whenever they are interested in buying a product or service.</p>
                  <p>
                  ...
                  <p>
                  So what's the solution? In order to help your business, you need to <Link to="https://infused.agency/get-started">hire a firm</Link> that specializes search engine optimization. That firm (us!) will help you figure out what keywords you need to rank for locally, and help your website rank for those specific terms.
                  </p>
                  <h2>Search engine optimization will help build trust &amp; credibility</h2>
                  <p>
                  Think about it.
                  </p>
                  <p>
