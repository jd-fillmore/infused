...
import featuredImg from "../img/niagara-falls-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Niagara Falls Web Design & SEO Marketing Company - Infused Agency
        </title>
        <meta
          name="description"
          content="Niagara Falls's leading web design &amp; SEO marketing agency. We're a website design agency thats brings more sales to your Niagara Falls company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Niagara Falls Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Niagara Falls Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Niagara Falls company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Niagara Falls area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Niagara Falls web design"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Niagara Falls and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Niagara Falls Web Designers Can Do For You"
        subTitle="Whether you need an professional Niagara Falls web design to showcase your services in Niagara Falls or want more local Niagara Falls customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Niagara Falls visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Niagara Falls companies that help convert Niagara Falls users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Niagara Falls website.",
        ]}
        boxTwoDesc="Getting local Niagara Falls traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Niagara Falls</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Niagara Falls business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Niagara Falls, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Niagara Falls business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Niagara Falls area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Niagara Falls web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Niagara Falls website design</h2>
              <p>
              ...
              <p>
                With so many Niagara Falls businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d93293.01766631182!2d-79.15824528666695!3d43.053911040395064!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d3445eec824db9%3A0x46d2c56156bda288!2sNiagara%20Falls%2C%20ON!5e0!3m2!1sen!2sca!4v1609181844433!5m2!1sen!2sca"
                width="100%"
                title="Niagara Falls map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Niagara Falls</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Niagara Falls business I do
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Niagara Falls web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Niagara
                Falls web design or SEO project today.
              </p>
              <Link to="/get-started">
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Niagara Falls area. We help local and
