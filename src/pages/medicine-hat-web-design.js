...
import featuredImg from "../img/medicine-hat-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Medicine Hat Web Design Company | Best Website Designers - Infused
          Agency
        </title>
        <meta
          name="description"
          content="Medicine Hat's best web design agency. We're a website design agency thats brings more sales to your Medicine Hat company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Medicine Hat Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Medicine Hat Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Medicine Hat company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Medicine Hat area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Medicine Hat web design company"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Medicine Hat and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Medicine Hat Web Designers Can Do For You"
        subTitle="Whether you need an professional Medicine Hat web design to showcase your services in Medicine Hat or want more local Medicine Hat customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Medicine Hat visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Medicine Hat companies that help convert Medicine Hat users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Medicine Hat website.",
        ]}
        boxTwoDesc="Getting local Medicine Hat traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Medicine Hat</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Medicine Hat business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Medicine Hat, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Medicine Hat business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Medicine Hat area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Medicine Hat web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Medicine Hat website design</h2>
              <p>
              ...
              <p>
                With so many Medicine Hat businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d81979.1028421559!2d-110.77926312197393!3d50.05169805275967!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x53132c563df9d417%3A0x13665e8c3280473f!2sMedicine%20Hat%2C%20AB!5e0!3m2!1sen!2sca!4v1609212467526!5m2!1sen!2sca"
                width="100%"
                title="Medicine Hat map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>
                Our Happy Web Design Clients In Or Outside Of Medicine Hat
              </h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Medicine Hat business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Medicine Hat web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Medicine
                Hat web design or SEO project today.
              </p>
              <Link to="/get-started">
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Medicine Hat area. We help local and
