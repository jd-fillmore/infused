...
import featuredImg from "../img/grande-prairie-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Grande Prairie Web Design Company | Best Website Designers - Infused
          Agency
        </title>
        <meta
          name="description"
          content="Grande Prairie's best web design agency. We're a website design agency thats brings more sales to your Grande Prairie company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Grande Prairie Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Grande Prairie Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Grande Prairie company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Grande Prairie area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Grande Prairie web design company"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Grande Prairie and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Grande Prairie Web Designers Can Do For You"
        subTitle="Whether you need an professional Grande Prairie web design to showcase your services in Grande Prairie or want more local Grande Prairie customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Grande Prairie visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Grande Prairie companies that help convert Grande Prairie users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Grande Prairie website.",
        ]}
        boxTwoDesc="Getting local Grande Prairie traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Grande Prairie</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Grande Prairie business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Grande Prairie, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Grande Prairie business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Grande Prairie area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Grande Prairie web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Grande Prairie website design</h2>
              <p>
              ...
              <p>
                With so many Grande Prairie businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d145810.8820263999!2d-118.96069575347765!3d55.17810903079189!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5390914965fb9b97%3A0x60726bc60c9e6409!2sGrande%20Prairie%2C%20AB!5e0!3m2!1sen!2sca!4v1609212732552!5m2!1sen!2sca"
                width="100%"
                title="Grande Prairie map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>
                Our Happy Web Design Clients In Or Outside Of Grande Prairie
              </h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Grande Prairie business I do
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Grande Prairie web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Grand
                Prairie web design or SEO project today.
              </p>
              <Link to="/get-started">
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Grande Prairie area. We help local and
