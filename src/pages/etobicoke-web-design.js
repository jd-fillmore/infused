...
import featuredImg from "../img/etobicoke-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Etobicoke Web Design Company | Best Website Designers - Infused Agency
        </title>
        <meta
          name="description"
          content="Etobicoke's best web design company. We're a website design agency thats brings more sales to your Etobicoke company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Etobicoke Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Etobicoke Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Etobicoke company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to Cass-A-Bella Construction's online existence by bringing them leads from the Etobicoke area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Etobicoke web design company"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Etobicoke and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Etobicoke Web Designers Can Do For You"
        subTitle="Whether you need an professional Etobicoke web design to showcase your services in Etobicoke or want more local Etobicoke customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Etobicoke visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Etobicoke companies that help convert Etobicoke users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Etobicoke website.",
        ]}
        boxTwoDesc="Getting local Etobicoke traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Etobicoke</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Etobicoke business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Etobicoke, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Etobicoke business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Etobicoke area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Etobicoke web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Etobicoke website design</h2>
              <p>
              ...
              <p>
                With so many Etobicoke businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d92346.58278616607!2d-79.62302116265448!3d43.6724904786255!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b3760d44c33c5%3A0x59e9c8bf2149d577!2sEtobicoke%2C%20Toronto%2C%20ON!5e0!3m2!1sen!2sca!4v1608679737948!5m2!1sen!2sca"
                width="100%"
                title="Etobicoke map"
                height="450"
                frameborder="0"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Etobicoke</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Etobicoke business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Etobicoke web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Etobicoke
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Etobicoke area. We help local and non-local
