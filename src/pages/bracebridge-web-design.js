...
import featuredImg from "../img/bracebridge-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Bracebridge Web Design & SEO Marketing Company - Infused Agency
        </title>
        <meta
          name="description"
          content="Bracebridge's leading web design &amp; SEO marketing agency. We're a website design agency thats brings more sales to your Bracebridge company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Bracebridge Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Bracebridge Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Bracebridge company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Bracebridge area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Bracebridge web design"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Bracebridge and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Bracebridge Web Designers Can Do For You"
        subTitle="Whether you need an professional Bracebridge web design to showcase your services in Bracebridge or want more local Bracebridge customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Bracebridge visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Bracebridge companies that help convert Bracebridge users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Bracebridge website.",
        ]}
        boxTwoDesc="Getting local Bracebridge traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Bracebridge</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Bracebridge business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Bracebridge, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Bracebridge business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Bracebridge area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Bracebridge web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Bracebridge website design</h2>
              <p>
              ...
              <p>
                With so many Bracebridge businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d180409.31818992205!2d-79.33731313356334!3d45.047340460426575!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4d2a86591569a5af%3A0x7b9e6032f59163f4!2sBracebridge%2C%20ON!5e0!3m2!1sen!2sca!4v1609178808627!5m2!1sen!2sca"
                width="100%"
                title="Bracebridge map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Bracebridge</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Bracebridge business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Bracebridge web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Bracebridge
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Bracebridge area. We help local and non-local
