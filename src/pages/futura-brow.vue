      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <p>
              Your website will have a modern design and will be developed on a
              platform that no other agency has access to, which makes us a very
              unique choice. We choose this platform to develop all of our
              websites as it's:
            </p>
            <ul>
