...
import featuredImg from "../img/peterborough-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Peterborough Web Design Company | Best Website Designers - Infused
          Agency
        </title>
        <meta
          name="description"
          content="Peterborough's best web design agency. We're a website design agency thats brings more sales to your Peterborough company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Peterborough Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Peterborough Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Peterborough company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Peterborough area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Peterborough web design"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Peterborough and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Peterborough Web Designers Can Do For You"
        subTitle="Whether you need an professional Peterborough web design to showcase your services in Peterborough or want more local Peterborough customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Peterborough visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Peterborough companies that help convert Peterborough users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Peterborough website.",
        ]}
        boxTwoDesc="Getting local Peterborough traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Peterborough</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Peterborough business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Peterborough, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Peterborough business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Peterborough area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Peterborough web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Peterborough website design</h2>
              <p>
              ...
              <p>
                With so many Peterborough businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d45675.874861079756!2d-78.36059319420039!3d44.31525051358901!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d58c91b5103a57%3A0x5037b28c72318e0!2sPeterborough%2C%20ON!5e0!3m2!1sen!2sca!4v1608669726786!5m2!1sen!2sca"
                width="100%"
                title="Peterborough map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Peterborough</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Peterborough business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Peterborough web design and SEO needs!!"
                  </p>
          ...
          <Row>
            <Col lg="5">
              ...
              <p>
                ...
                Peterborough web design or SEO project today.
              </p>
              <Link to="/get-started">
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Peterborough area. We help local and
