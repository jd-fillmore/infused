...
import featuredImg from "../img/charlottetown-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Charlottetown, PEI Web Design Company | Best Website Designers -
          Infused Agency
        </title>
        <meta
          name="description"
          content="Charlottetown, PEI's best web design agency. We're a website design agency thats brings more sales to your Charlottetown, PEI company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Charlottetown, PEI Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Charlottetown, PEI Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Charlottetown, PEI company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Charlottetown, PEI area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Charlottetown, PEI web design company"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Charlottetown, PEI and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Charlottetown, PEI Web Designers Can Do For You"
        subTitle="Whether you need an professional Charlottetown, PEI web design to showcase your services in Charlottetown, PEI or want more local Charlottetown, PEI customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Charlottetown, PEI visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Charlottetown, PEI companies that help convert Charlottetown, PEI users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Charlottetown, PEI website.",
        ]}
        boxTwoDesc="Getting local Charlottetown, PEI traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Charlottetown, PEI</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Charlottetown, PEI business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Charlottetown, PEI, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Charlottetown, PEI business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Charlottetown, PEI area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Charlottetown, PEI web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>
                Benefits of having a modern Charlottetown, PEI website design
              </h2>
              <p>
              ...
              <p>
                With so many Charlottetown, PEI businesses competing for
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d44134.559916545695!2d-63.17099504376036!3d46.26195582801318!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4b5e52ddd47f83c5%3A0x5a5777b89f519b27!2sCharlottetown%2C%20PE!5e0!3m2!1sen!2sca!4v1609195776285!5m2!1sen!2sca"
                width="100%"
                title="Charlottetown, PEI map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>
                Our Happy Web Design Clients In Or Outside Of Charlottetown, PEI
              </h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Charlottetown, PEI business I do
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Charlottetown, PEI web design and SEO needs!!"
                  </p>
          ...
          <Row>
            <Col lg="5">
              ...
              <p>
                ...
                Charlottetown, PEI web design or SEO project today.
              </p>
              <Link to="/get-started">
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Charlottetown, PEI area. We help local and
