    ...
    <section class="inner-hero" data-aos="fade-in" data-aos-duration="1000">
      <div class="container">
        <div class="row text-center">
          <div class="col-lg-12">
            <h1 data-aos="fade-in" data-aos-duration="1000" data-aos-delay="500">Search Engine Optimization (SEO)</h1>
            <p data-aos="fade-in" data-aos-duration="1000" data-aos-delay="1000">Getting you more sales through Google Search</p>
          </div>
        </div>
      </div>
    </section>
