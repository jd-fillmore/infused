...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Welland Web Design & SEO Marketing Company - Infused Agency
        </title>
        <meta
          name="description"
      ...
      <Nav />
      <Hero
        seoTitle="A Welland Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Welland Company."
      ...
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Welland area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
      ...
      />
      <WhatWeDo
        title="What Our Welland Web Designers Can Do For You"
        subTitle="Whether you need an professional Welland web design to showcase your services in Welland or want more local Welland customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Welland visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Welland companies that help convert Welland users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Welland website.",
        ]}
        boxTwoDesc="Getting local Welland traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Welland</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Welland business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Welland, st catharines"
        ...
        <Container>
          <Row>
            <Col lg="12">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d46702.37204824631!2d-79.2648081499332!3d42.9804169055262!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d349cb1aaf497d%3A0xb6a05855226db6e6!2sWelland%2C%20ON!5e0!3m2!1sen!2sca!4v1608668684812!5m2!1sen!2sca"
                width="100%"
                title="Welland map"
                height="450"
                frameborder="0"
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Welland web
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Welland area. We help local and non-local
