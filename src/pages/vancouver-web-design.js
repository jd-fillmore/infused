...
import featuredImg from "../img/vancouver-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Vancouver Web Design Company | Best Website Designers - Infused Agency
        </title>
        <meta
          name="description"
          content="Vancouver's best web design agency. We're a website design agency thats brings more sales to your Vancouver company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Vancouver Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Vancouver Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Vancouver company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Vancouver area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Vancouver web design company"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Vancouver and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Vancouver Web Designers Can Do For You"
        subTitle="Whether you need an professional Vancouver web design to showcase your services in Vancouver or want more local Vancouver customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Vancouver visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Vancouver companies that help convert Vancouver users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Vancouver website.",
        ]}
        boxTwoDesc="Getting local Vancouver traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Vancouver</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Vancouver business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Vancouver, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Vancouver business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Vancouver area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Vancouver web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Vancouver website design</h2>
              <p>
              ...
              <p>
                With so many Vancouver businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d166654.55163708015!2d-123.26398441732752!3d49.25787485362262!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x548673f143a94fb3%3A0xbb9196ea9b81f38b!2sVancouver%2C%20BC!5e0!3m2!1sen!2sca!4v1609213270957!5m2!1sen!2sca"
                width="100%"
                title="Vancouver map"
                height="450"
                frameborder="0"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Outside Of Vancouver</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Vancouver business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Vancouver web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Vancouver
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Vancouver area. We help local and non-local
