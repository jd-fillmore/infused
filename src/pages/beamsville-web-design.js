...
import featuredImg from "../img/beamsville-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Beamsville Web Design & SEO Marketing Company - Infused Agency
        </title>
        <meta
          name="description"
          content="Beamsville's leading web design &amp; SEO agency. We're a website design agency thats brings more sales to your Beamsville company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Beamsville Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Beamsville Company."
      ...
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Beamsville area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
      ...
      />
      <WhatWeDo
        title="What Our Beamsville Web Designers Can Do For You"
        subTitle="Whether you need an professional Beamsville web design to showcase your services in Beamsville or want more local Beamsville customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Beamsville visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Beamsville companies that help convert Beamsville users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Beamsville website.",
        ]}
        boxTwoDesc="Getting local Beamsville traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Beamsville</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Beamsville business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Beamsville, st catharines"
        ...
        <Container>
          <Row>
            <Col lg="12">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d23282.936108355905!2d-79.49632743716747!3d43.15981971503422!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882ca6a63bd9bd41%3A0x22e434fb6db3b5f!2sBeamsville%2C%20Lincoln%2C%20ON!5e0!3m2!1sen!2sca!4v1608663171467!5m2!1sen!2sca"
                width="100%"
                title="Beamsville map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Beamsville
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Beamsville area. We help local and non-local
