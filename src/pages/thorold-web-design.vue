    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Thorold web design. At Infused Agency, we help your Thorold-based business come up with a modern and easy to use website design, that will wow your customers."
      }
    ]
  }
};
