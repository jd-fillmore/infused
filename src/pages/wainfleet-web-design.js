...
import kdImg from "../img/wainfleet-web-design-seo.png"
...
const Wainfleet = () => {
  return (
    <>
      <Helmet>
        <title>Wainfleet Web Design & SEO Company - Infused</title>
        <meta
          name="description"
          content="Wainfleet's best web design and SEO company around. 10+ years in business helping hundreds of clients. Click here to view portfolio."
        />
      </Helmet>
      <Nav />
      <InnerHero
        title="Wainfleet Web Design & SEO Company"
        description="We help local Wainfleet businesses drive traffic & increase revenue online."
      />
      <InnerContent>
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-lg-6">
                <img
                  src={kdImg}
                  className="img-fluid"
                  alt="Wainfleet web design & seo company"
                />
              </div>
            </div>
          </div>
              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <p>
                    ...
                    Googles what they need, it's imperative to hire a Wainfleet
