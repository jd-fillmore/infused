...
import kdImg from "../img/niagara-on-the-lake-web-design-seo.png"
...
const NOTL = () => {
  return (
    <>
      <Helmet>
        <title>Niagara-on-the-Lake Web Design & SEO Company - Infused</title>
        <meta
          name="description"
          content="Niagara-on-the-Lake's best web design and SEO company around. 10+ years in business helping hundreds of clients. Click here to view portfolio."
        />
      </Helmet>
      <Nav />
      <InnerHero
        title="Niagara-on-the-Lake Web Design & SEO Company"
        description="We help local Niagara-on-the-Lake businesses drive traffic & increase revenue online."
      />
      <InnerContent>
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-lg-6">
                <img
                  src={kdImg}
                  className="img-fluid"
                  alt="Niagara-on-the-Lake web design & seo company"
                />
              </div>
            </div>
          </div>
          ...
          <section className="niche-intro">
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-md-12">
                  <h2>
                    Why Your Niagara-on-the-Lake Business Needs A Successful
                    Website
                  </h2>
                  <p>
                    ...
                    Niagara-on-the-Lake website development company that knows
