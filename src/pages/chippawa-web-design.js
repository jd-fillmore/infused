...
import featuredImg from "../img/chippawa-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Chippawa Web Design & SEO Marketing Company - Infused Agency
        </title>
        <meta
          name="description"
          content="Chippawa's leading web design &amp; SEO marketing agency. We're a website design agency thats brings more sales to your Chippawa company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Chippawa Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Chippawa Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Chippawa company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Chippawa area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Chippawa web design"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Chippawa and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Chippawa Web Designers Can Do For You"
        subTitle="Whether you need an professional Chippawa web design to showcase your services in Chippawa or want more local Chippawa customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Chippawa visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Chippawa companies that help convert Chippawa users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Chippawa website.",
        ]}
        boxTwoDesc="Getting local Chippawa traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Chippawa</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Chippawa business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Chippawa, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Chippawa business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Chippawa area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Chippawa web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Chippawa website design</h2>
              <p>
              ...
              <p>
                With so many Chippawa businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11660.685494677915!2d-79.05962920726354!3d43.058863114700145!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d342467b09af4d%3A0xeef72ec39251d7b6!2sChippawa%2C%20Niagara%20Falls%2C%20ON%20L2G%206B3!5e0!3m2!1sen!2sca!4v1609181025987!5m2!1sen!2sca"
                width="100%"
                title="Chippawa map"
                height="450"
                frameborder="0"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Chippawa</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Chippawa business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Chippawa web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Chippawa
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Chippawa area. We help local and non-local
