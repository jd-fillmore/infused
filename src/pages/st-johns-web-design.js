...
import featuredImg from "../img/st-johns-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          St. John's, Newfoundland Web Design Company | Best Website Designers -
          Infused Agency
        </title>
        <meta
          name="description"
          content="St. John's, Newfoundland's best web design agency. We're a website design agency thats brings more sales to your St. John's, Newfoundland company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A St. John's, Newfoundland Website Design &amp; Web Development Company"
        title="Effective Web Design For Your St. John's, Newfoundland Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your St. John's, Newfoundland company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the St. John's, Newfoundland area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="St. John's, Newfoundland web design company"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from St. John's, Newfoundland and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our St. John's, Newfoundland Web Designers Can Do For You"
        subTitle="Whether you need an professional St. John's, Newfoundland web design to showcase your services in St. John's, Newfoundland or want more local St. John's, Newfoundland customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your St. John's, Newfoundland visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for St. John's, Newfoundland companies that help convert St. John's, Newfoundland users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your St. John's, Newfoundland website.",
        ]}
        boxTwoDesc="Getting local St. John's, Newfoundland traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in St. John's, Newfoundland</span>,
          ".",
        ]}
        boxThreeDesc="Helping your St. John's, Newfoundland business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency St. John's, Newfoundland, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your St. John's, Newfoundland business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the St. John's, Newfoundland area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new St. John's, Newfoundland web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>
                Benefits of having a modern St. John's, Newfoundland website
                design
              </h2>
              <p>
              ...
              <p>
                With so many St. John's, Newfoundland businesses competing for
                eachother's customer-base, it's extremely important your company
                stands out.
                <br />
                <br />
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d172570.56834921733!2d-52.96812490718652!3d47.48182573326335!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4b0ca38e6b0aa261%3A0x9e1fd4001f12261f!2sSt.%20John&#39;s%2C%20NL!5e0!3m2!1sen!2sca!4v1609195810148!5m2!1sen!2sca"
                width="100%"
                title="St. John's, Newfoundland map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>
                Our Happy Web Design Clients In Or Outside Of St. John's,
                Newfoundland
              </h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your St. John's, Newfoundland business I
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your St. John's, Newfoundland web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your St. John's,
                Newfoundland web design or SEO project today.
              </p>
              <Link to="/get-started">
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the St. John's, Newfoundland area. We help local
                and non-local businesses build their credibility online, as well
                as help bring in more sales.
              </p>
            </Col>
            <Col lg="2">
              <h3>Pages</h3>
