...
import kdImg from "../img/fort-erie-web-design-seo.png"
...
const FortErie = () => {
  return (
    <>
      <Helmet>
        <title>Fort Erie Web Design & SEO Company - Infused</title>
        <meta
          name="description"
          content="Fort Erie's best web design and SEO company around. 10+ years in business helping hundreds of clients. Click here to view portfolio."
        />
      </Helmet>
      <Nav />
      <InnerHero
        title="Fort Erie Web Design & SEO Company"
        description="We help local Fort Erie businesses drive traffic & increase revenue online."
      />
      <InnerContent>
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-lg-6">
                <img
                  src={kdImg}
                  className="img-fluid"
                  alt="Fort Erie web design & seo company"
                />
              </div>
            </div>
          </div>
          ...
          <section className="niche-intro">
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-md-12">
                  <h2>
                    Why Your Fort Erie Business Needs A Successful Website
                  </h2>
                  <p>
                    ...
                    Googles what they need, it's imperative to hire a Fort Erie
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2>
                    How can Search Engine Optimization (SEO) help your Fort Erie
                    business?
                  </h2>
                  <p>
