...
import featuredImg from "../img/kawartha-lakes-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Kawartha Lakes Web Design & SEO Marketing Company - Infused Agency
        </title>
        <meta
          name="description"
          content="Kawartha Lakes's leading web design &amp; SEO marketing agency. We're a website design agency thats brings more sales to your Kawartha Lakes company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Kawartha Lakes Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Kawartha Lakes Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Kawartha Lakes company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Kawartha Lakes area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Kawartha Lakes web design"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Kawartha Lakes and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Kawartha Lakes Web Designers Can Do For You"
        subTitle="Whether you need an professional Kawartha Lakes web design to showcase your services in Kawartha Lakes or want more local Kawartha Lakes customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Kawartha Lakes visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Kawartha Lakes companies that help convert Kawartha Lakes users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Kawartha Lakes website.",
        ]}
        boxTwoDesc="Getting local Kawartha Lakes traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Kawartha Lakes</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Kawartha Lakes business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Kawartha Lakes, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Kawartha Lakes business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Kawartha Lakes area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Kawartha Lakes web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Kawartha Lakes website design</h2>
              <p>
              ...
              <p>
                With so many Kawartha Lakes businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d364116.2311801103!2d-79.097966271667!3d44.52215696193958!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89d57bdfc9344d85%3A0x22cdaf2b7cc6aaef!2sKawartha%20Lakes%2C%20ON!5e0!3m2!1sen!2sca!4v1609179904439!5m2!1sen!2sca"
                width="100%"
                title="Kawartha Lakes map"
                height="450"
                frameborder="0"
                allowfullscreen=""
                aria-hidden="false"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Kawartha Lakes</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Kawartha Lakes business I do
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Kawartha Lakes web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Kawartha
                Lakes web design or SEO project today.
              </p>
              <Link to="/get-started">
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Kawartha Lakes area. We help local and
