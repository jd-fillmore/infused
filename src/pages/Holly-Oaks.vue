    ...
    <section class="inner-hero" data-aos="fade-in" data-aos-duration="1000">
      <div class="container">
        <div class="row text-center">
          <div class="col-lg-12">
            <h1 data-aos="fade-in" data-aos-duration="1000" data-aos-delay="500">HollyOaks</h1>
      ...
      <div class="container" id="shrunk">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <g-image alt="ho results" src="~/img/hollyoaks-results.jpg" class="img-fluid" />
            <br><br>
            <p><strong>Disclaimer: I had worked full time at a web design and digital marketing company, contributing to the design and build of this website. The design and code belongs to that company, not mine.</strong></p>
          </div>
        </div>
      </div>
    </section>
...
export default {
  metaInfo: {
    title: 'HollyOaks Case Study',
    meta: [
      { key: 'description', name: 'description', content: 'HollyOaks website was designed and developed while working at a separate web design agency. Click here to view the case study.' }
    ]
  }
}
</script>
