  ...
  <Layout>
    ...
    <section class="featured" data-aos="fade-in" data-aos-duration="1000">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h3>Ranking #1 on Google Maps for Multiple Keywords</h3>
          </div>
          <div class="row">
            <div class="col-lg-4">
              <img
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <ul>
              <li>
                Motivation - frustrated as couldn't find any vegan food near.
                Other customers probably feel this frustration as well.
              </li>
              <li>Plant-based food</li>
              <li>Everyone's too busy to cook</li>
              <li>
                More of a destination that's a bit tucked away - therefore, an
                online presence to attract is imperative
              </li>
              <li>
                Up and running the place in about 5 months but would like an
              ...
              <li>All plant based foods</li>
              <li>
                Every effort made to eliminate artificial colours, flavours,
                gmo's, as much local produce as possible without chemical sprays
                (there won't be any of this but I never say "never or no" as
                there are people who will check every ingredient and ask for
                your suppliers to check their ingredients...these people never
                stop).
              </li>
              <li>
                Aiming towards zero waste facility with composting of all of our
                waste and packaging
              </li>
              <li>
              ...
              <li>
                Menu "daily grub" for regular menu items and "artisanal menu"
                for special events where I put all of my aromatherapy training
                into good use with high end desserts featuring dried and sugared
                flowers and natural plant extracts -seasonal items will include
                picnic basket orders
              </li>
              <li>
                "Daily grub" menu will be prepped and ready to go for lunch and
                dinner (all comfort foods) including some awesome desserts
              </li>
              <li>
                Order form for catering and B&B's in the area who may have
                guests with vegan/plant based diets (pandemic will put a big hit
                on that).
              </li>
              <li>
                Biggest mandate is that it is local, everything is made in house
                with real food , by local, hard-working people from our
                beautiful blue planet, which is quickly turning grungy
              </li>
            </ul>
            <h2>Project Investment</h2>
            <p>
              Phase 1 will be that of the web design and development phase. It
              will be developed on a platform that no other agency has access
              to, which makes us a very unique choice. We choose this platform
              to develop all of our websites as it's:
            </p>
            <ul>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <p>
              Three affordable packages to choose from. First month upfront,
              website launch within a month.
            </p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card">
              <h3><sup>$</sup>299.99 / mo</h3>
              <h6>For 1 year</h6>
              <p>Up to 10 pages</p>
              <ul>
                <li>Everything from Beginner package</li>
                <li>
                  1 local city sale funnel page, optimized to rank high in
                  Google
                </li>
                <li>
                ...
                <li>Contact form to collect leads</li>
                <li></li>
              </ul>
            </div>
          </div>
          <div class="col-md-4">
            ...
            <div class="card">
              ...
              <p>Unlimited pages</p>
              <ul>
                <li>Everything from Professional package</li>
                <li>E-commerce</li>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <p>
              Pricing will be charged at $120 / hour and when the time comes, we
