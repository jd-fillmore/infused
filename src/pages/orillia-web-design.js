...
import featuredImg from "../img/orillia-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Orillia Web Design Company | Best Website Designers - Infused Agency
        </title>
        <meta
          name="description"
          content="Orillia's best web design company. We're a website design agency thats brings more sales to your Orillia company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Orillia Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Orillia Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Orillia company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to Cass-A-Bella Construction's online existence by bringing them leads from the Orillia area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Orillia web design company"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Orillia and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Orillia Web Designers Can Do For You"
        subTitle="Whether you need an professional Orillia web design to showcase your services in Orillia or want more local Orillia customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Orillia visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Orillia companies that help convert Orillia users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Orillia website.",
        ]}
        boxTwoDesc="Getting local Orillia traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Orillia</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Orillia business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Orillia, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Orillia business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Orillia area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Orillia web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Orillia website design</h2>
              <p>
              ...
              <p>
                With so many Orillia businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d45451.45694337972!2d-79.4549375527063!3d44.602832623310896!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4d2aa93c483b6195%3A0xfc76a43d237f733c!2sOrillia%2C%20ON!5e0!3m2!1sen!2sca!4v1608678447946!5m2!1sen!2sca"
                width="100%"
                title="Orillia map"
                height="450"
                frameborder="0"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near Orillia</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Orillia business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Orillia web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Orillia web
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Orillia area. We help local and non-local
