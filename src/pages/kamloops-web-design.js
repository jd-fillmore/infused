...
import featuredImg from "../img/kamloops-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          Kamloops Web Design Company | Best Website Designers - Infused Agency
        </title>
        <meta
          name="description"
          content="Kamloops's best web design agency. We're a website design agency thats brings more sales to your Kamloops company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A Kamloops Website Design &amp; Web Development Company"
        title="Effective Web Design For Your Kamloops Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your Kamloops company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the Kamloops area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="Kamloops web design company"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from Kamloops and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our Kamloops Web Designers Can Do For You"
        subTitle="Whether you need an professional Kamloops web design to showcase your services in Kamloops or want more local Kamloops customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your Kamloops visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for Kamloops companies that help convert Kamloops users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your Kamloops website.",
        ]}
        boxTwoDesc="Getting local Kamloops traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in Kamloops</span>,
          ".",
        ]}
        boxThreeDesc="Helping your Kamloops business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency Kamloops, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your Kamloops business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the Kamloops area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new Kamloops web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern Kamloops website design</h2>
              <p>
              ...
              <p>
                With so many Kamloops businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d323176.77672941086!2d-120.57889885998937!3d50.741853855057336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x537e2cd33d0d3b31%3A0xd23e96aa9a6945e7!2sKamloops%2C%20BC!5e0!3m2!1sen!2sca!4v1609213147733!5m2!1sen!2sca"
                width="100%"
                title="Kamloops map"
                height="450"
                frameborder="0"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Outside Of Kamloops</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your Kamloops business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your Kamloops web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your Kamloops
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the Kamloops area. We help local and non-local
