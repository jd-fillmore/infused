        ...
        <div class="row text-center">
          <div class="col-lg-12">
            ...
            <p
              ...
              data-aos-delay="1000"
            >Website Design, Development &amp; SEO Proposal</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
          ...
          <div class="col-md-4">
            ...
            <div class="card">
              ...
              <ul>
                ...
                <li>1 local city sale funnel page, optimized to rank high in Google</li>
                ...
                <li>Store (link to shopify site)</li>
                <li>Refills (link to third party)</li>
                <li>Flyers (link to third party)</li>
                <li>Links to social media platforms</li>
              </ul>
            </div>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <p>Pricing will be charged at $120 / hour and when the time comes, we will be happy to provide a quote based on how we will market online and how long things will take. This will include:</p>
            <ul>
              <li>Designing ads</li>
