...
import featuredImg from "../img/north-bay-web-design.png"
...
const City = () => {
  return (
    <>
      <Helmet>
        <title>
          North Bay Web Design & SEO Marketing Company - Infused Agency
        </title>
        <meta
          name="description"
          content="North Bay's leading web design &amp; SEO marketing agency. We're a website design agency thats brings more sales to your North Bay company."
        />
      </Helmet>
      <Nav />
      <Hero
        seoTitle="A North Bay Website Design &amp; Web Development Company"
        title="Effective Web Design For Your North Bay Company."
        subTitle="We do modern web design &amp; build modern websites to help you grow your North Bay company."
        btnText="Get Started"
        btnLink="/get-started"
      />
      <Featured
        ...
        subTitle={[
          ...
          "we've made to KD Flower's online existence by bringing them leads from the North Bay area, by utilizing modern web design and SEO practices.",
        ]}
        viewsValue="10,700"
        ...
        img={featuredImg}
        imgAlt="North Bay web design"
        testimonial={[
          "Infused created the ",
          <span>perfect web design</span>,
          "for my  floral business. Many of my clients come from North Bay and I was very happy with their ",
      ...
      />
      <WhatWeDo
        title="What Our North Bay Web Designers Can Do For You"
        subTitle="Whether you need an professional North Bay web design to showcase your services in North Bay or want more local North Bay customers from your website design - we can build you a web design that's tailor-made to your business needs."
        boxOneTitle={[
          "Bespoke web design built to ",
          <span>convert your North Bay visitors</span>,
          ".",
        ]}
        boxOneDesc="We do modern web design &amp; website development for North Bay companies that help convert North Bay users into paying customers."
        ...
        boxTwoTitle={[
          ...
          " to your North Bay website.",
        ]}
        boxTwoDesc="Getting local North Bay traffic through SEO to your modern web design helps bring you more revenue."
        boxTwoImg={seoSVG}
        boxTwoImgAlt="seo provider st catharines"
        boxTwoLink="/seo"
        boxThreeTitle={[
          "Digital strategy to help bring you ",
          <span>more revenue in North Bay</span>,
          ".",
        ]}
        boxThreeDesc="Helping your North Bay business navigate through the digital world to help maximize profits."
        boxThreeImg={strategySVG}
        boxThreeImgAlt="digital strategy agency North Bay, st catharines"
      ...
      <Process
        ...
        descOne="On a quick 15-20 minute call, we discuss and extract everything you're interested in for your North Bay business. Whether it's a new web design, or you'd like to bring more customers / clients to your business through local SEO or digital strategy, we gather all of the necessary information for your project."
        titleTwo="2. Project Evaluation"
        subTitleTwo="Deep-dive project evaluation with bespoke recommendations."
        descTwo={[
          "Virtually all digital and web design agencies offer a project proposal - not us. Enter the Project Evaluation. We want to thoroughly get to know your company, your business goals in the North Bay area and what you'd like to accomplish with your project.",
          <br />,
          <br />,
          "Based on our in-depth research and findings, we will offer you extremely detailed recommendations on how to move forward. If you agree to move forward with us, we get the important stuff signed, requirements delivered and the project is underway for your new North Bay web design or SEO project.",
        ]}
      ...
      <section className="city-benefits">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Benefits of having a modern North Bay website design</h2>
              <p>
              ...
              <p>
                With so many North Bay businesses competing for eachother's
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d88155.38476763059!2d-79.45074621392894!3d46.332557543461256!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4d2854b13122e2ef%3A0x5037b28c7232700!2sNorth%20Bay%2C%20ON!5e0!3m2!1sen!2sca!4v1609178963426!5m2!1sen!2sca"
                width="100%"
                title="North Bay map"
                height="450"
                frameborder="0"
      ...
      <section className="clients text-center">
        <Container>
          <Row>
            <Col lg="12">
              <h2>Our Happy Web Design Clients In Or Near North Bay</h2>
              <hr />
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    new web design for your North Bay business I do recommend
              ...
              <div>
                <TestimonialCard>
                  <p>
                    ...
                    your North Bay web design and SEO needs!!"
                  </p>
        ...
        <Container>
          <Row>
            <Col lg="5">
              ...
              <p>
                Get in touch with us for a free quote regarding your North Bay
          ...
          <Row>
            <Col lg="4">
              ...
              <p>
                ...
                agency serving the North Bay area. We help local and non-local
